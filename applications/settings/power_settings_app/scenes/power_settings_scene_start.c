...
void power_settings_scene_start_on_enter(void* context) {
    ...
    variable_item_list_add(variable_item_list, "Info Batterie", 1, NULL, NULL);

    variable_item_list_add(variable_item_list, "Redémarrage", 1, NULL, NULL);

    variable_item_list_add(variable_item_list, "Éteindre", 1, NULL, NULL);
