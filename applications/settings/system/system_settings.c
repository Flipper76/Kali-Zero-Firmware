...
SystemSettings* system_settings_alloc() {
    ...
    item = variable_item_list_add(
        app->var_item_list, "Format heure", COUNT_OF(time_format_text), time_format_changed, app);
    value_index = value_index_uint32(
    ...
    item = variable_item_list_add(
        app->var_item_list, "Format Date", COUNT_OF(date_format_text), date_format_changed, app);
    value_index = value_index_uint32(
    ...
    item = variable_item_list_add(
        app->var_item_list, "Niveau Log", COUNT_OF(log_level_text), log_level_changed, app);
    value_index = value_index_uint32(
    ...
    item = variable_item_list_add(
        app->var_item_list, "Dispositif Log", COUNT_OF(log_device_text), log_device_changed, app);
    value_index = value_index_uint32(
    ...
    item = variable_item_list_add(
        app->var_item_list, "Nom du fichier", COUNT_OF(filename_scheme), filename_scheme_changed, app);
