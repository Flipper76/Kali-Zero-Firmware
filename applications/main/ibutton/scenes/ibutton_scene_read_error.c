...
void ibutton_scene_read_error_on_enter(void* context) {
    ...
    widget_add_button_element(
        widget, GuiButtonTypeLeft, "Retenter", ibutton_widget_callback, context);
    widget_add_button_element(
        widget, GuiButtonTypeRight, "Plus", ibutton_widget_callback, context);

    widget_add_string_element(
        widget, 128 / 2, 2, AlignCenter, AlignTop, FontPrimary, "Erreur de lecture");
