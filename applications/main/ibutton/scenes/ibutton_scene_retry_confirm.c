...
void ibutton_scene_retry_confirm_on_enter(void* context) {
    ...
    widget_add_button_element(
        widget, GuiButtonTypeLeft, "Quitter", ibutton_scene_retry_confirm_widget_callback, ibutton);
    widget_add_button_element(
        widget, GuiButtonTypeRight, "Rester", ibutton_scene_retry_confirm_widget_callback, ibutton);
    widget_add_string_element(
        widget, 64, 19, AlignCenter, AlignBottom, FontPrimary, "Retenter lecture?");
    widget_add_string_element(
        widget, 64, 29, AlignCenter, AlignBottom, FontSecondary, "Toutes donn""\xE9""es non \nenregistr""\xE9""es seront perdues");
