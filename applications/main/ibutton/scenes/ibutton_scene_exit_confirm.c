...
void ibutton_scene_exit_confirm_on_enter(void* context) {
    ...
    widget_add_button_element(
        widget, GuiButtonTypeLeft, "Quitter", ibutton_scene_exit_confirm_widget_callback, ibutton);
    widget_add_button_element(
        widget, GuiButtonTypeRight, "Rester", ibutton_scene_exit_confirm_widget_callback, ibutton);
    widget_add_string_element(
        widget, 64, 19, AlignCenter, AlignBottom, FontPrimary, "Quitter le menu iButton?");
    widget_add_string_element(
