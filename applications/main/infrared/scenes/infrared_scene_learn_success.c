...
void infrared_scene_learn_success_on_enter(void* context) {
    ...
    if(infrared_signal_is_raw(signal)) {
        ...
        dialog_ex_set_header(dialog_ex, "Inconnu", 95, 10, AlignCenter, AlignCenter);
        infrared_text_store_set(infrared, 0, "Exemple %zu", raw->timings_size);
    ...
    dialog_ex_set_left_button_text(dialog_ex, "Retour");
    dialog_ex_set_right_button_text(dialog_ex, "Enreg.");
    dialog_ex_set_center_button_text(dialog_ex, "Envoie");
