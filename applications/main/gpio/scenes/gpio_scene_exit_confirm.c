...
void gpio_scene_exit_confirm_on_enter(void* context) {
    ...
    dialog_ex_set_left_button_text(dialog, "Quitter");
    dialog_ex_set_right_button_text(dialog, "Rester");
    dialog_ex_set_header(dialog, "Quitter USB-UART?", 22, 12, AlignLeft, AlignTop);
