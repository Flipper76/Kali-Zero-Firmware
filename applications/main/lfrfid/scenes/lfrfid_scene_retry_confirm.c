...
void lfrfid_scene_retry_confirm_on_enter(void* context) {
    ...
    widget_add_button_element(widget, GuiButtonTypeRight, "Rester", lfrfid_widget_callback, app);
    widget_add_string_element(
        widget, 64, 19, AlignCenter, AlignBottom, FontPrimary, "Retenter de lire?");
    widget_add_string_element(
