...
void lfrfid_scene_delete_confirm_on_enter(void* context) {
    ...
    widget_add_button_element(widget, GuiButtonTypeRight, "Supprimer", lfrfid_widget_callback, app);

    furi_string_printf(tmp_string, "Supprimer %s?", furi_string_get_cstr(app->file_name));
