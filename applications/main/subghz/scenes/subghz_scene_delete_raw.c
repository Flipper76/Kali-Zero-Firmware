...
void subghz_scene_delete_raw_on_enter(void* context) {
    ...
    snprintf(delete_str, sizeof(delete_str), "\e#Supprimer %s?\e#", furi_string_get_cstr(file_name));
    ...
    widget_add_button_element(
        subghz->widget, GuiButtonTypeRight, "Supprimer", subghz_scene_delete_raw_callback, subghz);
    widget_add_button_element(
        subghz->widget, GuiButtonTypeLeft, "Retour", subghz_scene_delete_raw_callback, subghz);
