...
void subghz_scene_delete_on_enter(void* context) {
    ...
    furi_string_cat_printf(text_out, "\e#Supprimer %s?\e#\n", furi_string_get_cstr(text));
    ...
    widget_add_button_element(
        subghz->widget, GuiButtonTypeRight, "Supprimer", subghz_scene_delete_callback, subghz);
    widget_add_button_element(
        subghz->widget, GuiButtonTypeLeft, "Annuler", subghz_scene_delete_callback, subghz);
