...
void subghz_scene_need_saving_on_enter(void* context) {
    ...
    widget_add_string_multiline_element(
        subghz->widget, 64, 13, AlignCenter, AlignCenter, FontPrimary, "Rejeter les signaux?");
    widget_add_string_multiline_element(
        subghz->widget,
        64,
        32,
        ...
        AlignCenter,
        FontSecondary,
		"Toutes données \nnon enregistr""\xE9""es \nseront perdues");

    widget_add_button_element(
        subghz->widget, GuiButtonTypeRight, "Rester", subghz_scene_need_saving_callback, subghz);
    widget_add_button_element(
        subghz->widget, GuiButtonTypeLeft, "Continuer", subghz_scene_need_saving_callback, subghz);
