...
void nfc_playlist_settings_scene_on_enter(void* context) {
    ...
    variable_item_list_set_header(nfc_playlist->variable_item_list, "Paramètres");
    ...
    variable_item_list_add(nfc_playlist->variable_item_list, "Réinitialiser paramètres", 0, NULL, NULL);

    VariableItem* credits =
        variable_item_list_add(nfc_playlist->variable_item_list, "kalicem", 1, NULL, NULL);
