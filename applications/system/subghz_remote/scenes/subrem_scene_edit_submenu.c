...
void subrem_scene_edit_submenu_on_enter(void* context) {
    ...
    submenu_add_item(
        submenu, "Modifier le label", EditSubmenuIndexEditLabel, subrem_scene_edit_submenu_callback, app);
    submenu_add_item(
        submenu, "Modifier le Fichier", EditSubmenuIndexEditFile, subrem_scene_edit_submenu_callback, app);
