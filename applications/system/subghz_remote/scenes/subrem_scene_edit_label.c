...
void subrem_scene_edit_label_on_enter(void* context) {
    ...
    text_input_set_header_text(text_input, "Nom du label");
    ...
    widget_add_string_element(
        app->widget, 63, 12, AlignCenter, AlignCenter, FontPrimary, "Label vide");
    widget_add_string_element(
        app->widget, 63, 32, AlignCenter, AlignCenter, FontSecondary, "Continuer?");

    widget_add_button_element(
        app->widget, GuiButtonTypeCenter, "Ok", subrem_scene_edit_label_widget_callback, app);
    widget_add_button_element(
        app->widget, GuiButtonTypeLeft, "Retour", subrem_scene_edit_label_widget_callback, app);
