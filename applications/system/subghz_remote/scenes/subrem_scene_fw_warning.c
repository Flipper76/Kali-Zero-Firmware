...
static void
    ...
    case SceneFwWarningStateAttention:
        widget_add_button_element(
            widget, GuiButtonTypeLeft, "Quitter", subrem_scene_fw_warning_widget_callback, app);
        widget_add_button_element(
            widget, GuiButtonTypeRight, "Continuer", subrem_scene_fw_warning_widget_callback, app);
        widget_add_string_element(
            widget, 64, 12, AlignCenter, AlignBottom, FontPrimary, "FW non officiel");
    ...
    case SceneFwWarningStateAccept:
        widget_add_button_element(
            widget, GuiButtonTypeLeft, "Quitter", subrem_scene_fw_warning_widget_callback, app);
        widget_add_button_element(
            widget, GuiButtonTypeRight, "Accepter", subrem_scene_fw_warning_widget_callback, app);
        widget_add_string_element(
            widget, 64, 12, AlignCenter, AlignBottom, FontPrimary, "FW non officiel");
        widget_add_string_multiline_element(
            widget,
