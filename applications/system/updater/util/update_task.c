...
static const char* update_task_stage_descr[] = {
    ...
    [UpdateTaskStageReadManifest] = "Charg. manifeste maj",
    [UpdateTaskStageValidateDFUImage] = "Test fichier DFU",
    [UpdateTaskStageFlashWrite] = "Écriture flash",
    [UpdateTaskStageFlashValidate] = "Validation flash",
    [UpdateTaskStageRadioImageValidate] = "Test firmware radio",
    [UpdateTaskStageRadioErase] = "Suppr. firmware radio",
    [UpdateTaskStageRadioWrite] = "Ecriture FW radio",
    [UpdateTaskStageRadioInstall] = "Install. firmware radio",
    [UpdateTaskStageRadioBusy] = "Noyau 2 indisponible",
    [UpdateTaskStageOBValidation] = "Validation opt. octets",
    [UpdateTaskStageIntBackup] = "Sauvegarde Config",
    [UpdateTaskStageIntRestore] = "Restauration Config",
    [UpdateTaskStageResourcesFileCleanup] = "Nettoyage fichiers",
    [UpdateTaskStageResourcesDirCleanup] = "Nettoyage répertoires",
    [UpdateTaskStageResourcesFileUnpack] = "Extraction resources",
    [UpdateTaskStageSplashscreenInstall] = "Install. splashscreen",
    [UpdateTaskStageCompleted] = "Redémarrage...",
    [UpdateTaskStageError] = "Erreur",
    [UpdateTaskStageOBError] = "OB, rapport",
};
...
static const struct {
...
} update_task_error_detail[] = {
    {
        ...
        .percent_min = 0,
        .percent_max = 13,
        .descr = "Appareil de MAJ incorrect",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 14,
        .percent_max = 20,
        .descr = "Erreur de pointeur de manifeste",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 21,
        .percent_max = 30,
        .descr = "Erreur de chargement du manifeste",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 31,
        .percent_max = 40,
        .descr = "Mauvaise version du package",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 41,
        .percent_max = 50,
        .descr = "Discordance de cible HW",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 51,
        .percent_max = 60,
        .descr = "Aucun fichier DFU",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 61,
        .percent_max = 80,
        .descr = "Aucun fichier Radio",
    },
...
#else
    {
        ...
        .percent_min = 0,
        .percent_max = 98,
        .descr = "Erreur lecture FS",
    },
    {
        .stage = UpdateTaskStageRadioImageValidate,
        .percent_min = 99,
        .percent_max = 100,
        .descr = "discordance CRC",
    },
    {
        .stage = UpdateTaskStageRadioErase,
        .percent_min = 0,
        .percent_max = 30,
        .descr = "Suppression pile: erreur cmd",
    },
    {
        .stage = UpdateTaskStageRadioErase,
        .percent_min = 31,
        .percent_max = 100,
        .descr = "Suppr. pile: Echec attente",
    },
    {
        .stage = UpdateTaskStageRadioWrite,
        .percent_min = 0,
        .percent_max = 100,
        .descr = "Ecriture pile : erreur",
    },
    {
        .stage = UpdateTaskStageRadioInstall,
        .percent_min = 0,
        .percent_max = 10,
        .descr = "Installation pile : erreur cmd",
    },
    {
        .stage = UpdateTaskStageRadioInstall,
        .percent_min = 11,
        .percent_max = 100,
        .descr = "Install. pile : Echec attente",
    },
    {
        .stage = UpdateTaskStageRadioBusy,
        .percent_min = 0,
        .percent_max = 10,
        .descr = "Démarrage C2 Impossible",
    },
    {
        .stage = UpdateTaskStageRadioBusy,
        .percent_min = 11,
        .percent_max = 20,
        .descr = "Echec commutateur C2 FUS",
    },
    {
        .stage = UpdateTaskStageRadioBusy,
        .percent_min = 21,
    ...
    },
    {
        ...
        .percent_min = 31,
        .percent_max = 100,
        .descr = "Echec commutateur C2 Stach",
    },
    {
        .stage = UpdateTaskStageOBValidation,
        .percent_min = 0,
        .percent_max = 100,
        .descr = "Discordance de valeur",
    },
    {
        .stage = UpdateTaskStageValidateDFUImage,
        .percent_min = 0,
        .percent_max = 1,
        .descr = "Echec ouverture fichier DFU",
    },
    {
        .stage = UpdateTaskStageValidateDFUImage,
        .percent_min = 1,
        .percent_max = 97,
        .descr = "Erreur lecture fichier DFU",
    },
    {
        .stage = UpdateTaskStageValidateDFUImage,
        .percent_min = 98,
        .percent_max = 100,
        .descr = "Incompat. CRC fichier DFU",
    },
    {
        .stage = UpdateTaskStageFlashWrite,
        .percent_min = 0,
        .percent_max = 100,
        .descr = "Erreur d'écriture Flash",
    },
    {
        .stage = UpdateTaskStageFlashValidate,
        .percent_min = 0,
        .percent_max = 100,
        .descr = "Erreur comparaison Flash",
    },
#endif
#ifndef FURI_RAM_EXEC
    {
    ...
    },
    {
        ...
        .percent_min = 0,
        .percent_max = 100,
        .descr = "Erreur d'E/S LFS",
    },
    {
        .stage = UpdateTaskStageResourcesFileUnpack,
        .percent_min = 0,
        .percent_max = 100,
        .descr = "Erreur d'E/S  SD",
    },
#endif
};
