...
static void hid_keynote_draw_callback(Canvas* canvas, void* context) {
    ...
    canvas_draw_icon(canvas, 64, 2, &I_Pin_back_arrow_10x8);
    canvas_set_font(canvas, FontSecondary);
    elements_multiline_text_aligned(canvas, 122, 3, AlignRight, AlignTop, "Tenir pour\nsortir");
    ...
    elements_multiline_text_aligned(canvas, 91, 36, AlignLeft, AlignBottom, "Espace");
    canvas_set_color(canvas, ColorBlack);
    ...
    elements_multiline_text_aligned(canvas, 91, 57, AlignLeft, AlignBottom, "Retour");
}
...
static void hid_keynote_draw_vertical_callback(Canvas* canvas, void* context) {
    ...
    canvas_set_font(canvas, FontSecondary);
    elements_multiline_text_aligned(canvas, 15, 19, AlignLeft, AlignTop, "Tenir pour\nsortir");
    ...
    elements_multiline_text_aligned(canvas, 26, 98, AlignLeft, AlignBottom, "Espace");
    canvas_set_color(canvas, ColorBlack);
    ...
    elements_multiline_text_aligned(canvas, 26, 119, AlignLeft, AlignBottom, "Retour");
}
