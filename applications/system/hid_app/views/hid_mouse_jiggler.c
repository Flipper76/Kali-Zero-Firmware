...
static void hid_mouse_jiggler_draw_callback(Canvas* canvas, void* context) {
    ...
    elements_multiline_text_aligned(canvas, 17, 2, AlignLeft, AlignTop, "Jiggler Souris");
    ...
    elements_multiline_text_aligned(canvas, 91, 62, AlignLeft, AlignBottom, "Quitter");
}
