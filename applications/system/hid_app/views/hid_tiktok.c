...
static void hid_tiktok_draw_callback(Canvas* canvas, void* context) {
    ...
    elements_multiline_text_aligned(canvas, 3, 18, AlignLeft, AlignTop, "YT Raccourcie");
    ...
    canvas_set_font(canvas, FontSecondary);
    elements_multiline_text_aligned(canvas, 13, 62, AlignLeft, AlignBottom, "Tenir pour sortir");
}
