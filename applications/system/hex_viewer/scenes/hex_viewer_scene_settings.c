...
void hex_viewer_scene_settings_on_enter(void* context) {
    ...
    item = variable_item_list_add(
        app->variable_item_list, "Vibreur/Haptique:", 2, hex_viewer_scene_settings_set_haptic, app);
    ...
    // Sound on/off
    item = variable_item_list_add(
        app->variable_item_list, "Son:", 2, hex_viewer_scene_settings_set_speaker, app);
