...
static const uint16_t hid_asciimap[] = {
    ...
    HID_KEYBOARD_UGRAVE | KEY_MOD_LEFT_SHIFT, // %
    ...
    HID_KEYBOARD_DOUBLEDOT | KEY_MOD_LEFT_SHIFT, // /
    HID_KEYBOARD_EXCLA | KEY_MOD_LEFT_SHIFT, // §
    ...
    HID_KEYBOARD_DOLAR | KEY_MOD_LEFT_SHIFT, // }
